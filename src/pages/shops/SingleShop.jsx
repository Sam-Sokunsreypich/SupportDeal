...
import { getAllShops } from "../../components/data/shop.js";
import getAllProduct from "../../components/data/products.js";
...
export default function SingleShop() {
  ...
  const products = getAllProduct().filter(
    (product) => product.shop === shop?.name
  );

  if (!shop) {
    return (
      <h2 className="text-center text-red-500 text-xl">Shop not found!</h2>
    );
  }

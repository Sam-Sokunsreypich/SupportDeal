...
export default function Products() {
  ...
  return (
    <>
    <div className='mt-28'>
     <h2 className='px-16 my-10 text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold flex justify-center bg-gradient-to-r from-orange-500 to-purple-500 bg-clip-text text-transparent '>All Products</h2> 
    </div>
    {/* cards */}

...
<footer className="bg-gradient-to-r from-orange-400 to-purple-400 px-5 md:px-10 lg:px-20">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link to="/" className="flex items-center">
                  <img src="/assets/logo.png" className="h-10 rounded-full me-3" alt="FlowBite Logo" />
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="text-gray-600 hover:text-gray-900 dark:hover:text-white ms-5">
